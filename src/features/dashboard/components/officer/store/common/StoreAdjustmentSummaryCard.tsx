...
export default function StoreAdjustmentSummaryCard({
  mutation,
}: {
  mutation: StoreStockAdjustmentDraft;
}) {
  return (
    <section className="rounded-[14px] border border-border bg-white px-4 py-4 shadow-sm">
      ...
      <div className="mt-4 space-y-3.5">
        {[
          ...
          ["Jenis penyesuaian", mutation.adjustmentLabel],
          ["Selisih stok", mutation.quantityDifference],
          ["Stok total", mutation.totalQuantity],
