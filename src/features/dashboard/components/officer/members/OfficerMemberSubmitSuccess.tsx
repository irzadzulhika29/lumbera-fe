...
export default function OfficerMemberSubmitSuccess({
  memberCount,
  onAddAgain,
}: {
  memberCount: number;
    ...
    >
      <div className="flex flex-1 flex-col items-center text-center">
        ...
        >
          ...
          >
            Anda berhasil menyimpan data anggota
          </motion.p>
        </motion.div>

        <div className="mt-8 w-full rounded-[12px] border-2 border-[#d9dde2] bg-white px-5 py-4 text-left">
          <div className="flex items-center justify-between gap-4">
            <span className="text-[1rem] font-bold text-text/72">
              Jumlah Anggota Tersimpan
            </span>
            <span className="text-right text-[1rem] font-medium text-text/86">
              {memberCount} Anggota
            </span>
          </div>
        </div>
